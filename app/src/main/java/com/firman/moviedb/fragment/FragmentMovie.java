package com.firman.moviedb.fragment;
...
import com.firman.moviedb.activities.DetailMovieActivity;
import com.firman.moviedb.adapter.MovieAdapter;
import com.firman.moviedb.adapter.MovieHorizontalAdapter;
import com.firman.moviedb.model.ModelMovie;
import com.firman.moviedb.API.ApiEndpoint;
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(getActivity(), "Tidak dapat menampilkan data....", Toast.LENGTH_SHORT).show();
                        }
                    }
